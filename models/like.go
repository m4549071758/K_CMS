...
type Like struct {
	...
	ArticleID   uuid.UUID `gorm:"type:char(36);not null;uniqueIndex:idx_like_article_fp" json:"article_id"`
	Fingerprint string    `gorm:"type:varchar(255);not null;uniqueIndex:idx_like_article_fp" json:"fingerprint"`
